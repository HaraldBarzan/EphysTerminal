...
namespace TINS.Terminal.Protocols.Genus
{
		...
		: StateMachine<GenusClosedLoopState, GenusEvent>
	{
		...
		public CL2StateMachine(GenusCL2 protocol)
		{
				...
				a is TFSpectrumAnalyzer analyzer)
			{
				...
				{
					case CL2AlgorithmVersion.V1: _alg = new CL2V1(_p, analyzer); break;
					case CL2AlgorithmVersion.V2: _alg = new CL2V2(_p, analyzer); break;
					case CL2AlgorithmVersion.V3: _alg = new CL2V3(_p, analyzer); break;
					case CL2AlgorithmVersion.V4: _alg = new CL2V4(_p, analyzer); break;
					default:
						throw new Exception();
				}
		...
		: ProtocolConfig
	{
		...
		/// </summary>
		[INILine(Key = "CLOSED_LOOP_ALGORITHM", Default = CL2AlgorithmVersion.V1)]
